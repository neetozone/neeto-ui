      ...
      return (
        <tr key={transform.name}>
          <td className="neeto-ui-bg-gray-800 p-2">
            <div className="p-6">
              <div
                className={`neeto-ui-text-black neeto-ui-bg-white flex h-12 w-36 items-center justify-center rounded-sm ${transform.name.replace(
                  "$neeto-ui",
                  "neeto-ui"
                )}`}
              >
